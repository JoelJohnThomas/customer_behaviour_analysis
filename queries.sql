...
COUNT(customer_id),  
ROUND(AVG(purchase_amount::numeric),2) as "Average purchase", 
SUM(purchase_amount) as "Total purchase"
from customer
group by subscription_status
order by "Total purchase", "Average purchase"
...
-- Q7. Segment customers into New, Returning and Loyal based on the total number of previous purchases and 
